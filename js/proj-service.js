...
function generateProjects(){
    ...
    'projects/proj-minesweeper/index.html', '16/05/2019', 'recursion, game'));
    gProjects.push(new Project(gId++, 'bookShop', 'Book Shop', 'manage your own book shop',
    'projects/proj-bookshop/index.html', '27/05/2019', 'bootstrap, jQuery, shop'));
...
function Project(id, name, title, description, url, publishedAt, labels){
    this.id = id,
    this.name = name,
    this.title = title,
